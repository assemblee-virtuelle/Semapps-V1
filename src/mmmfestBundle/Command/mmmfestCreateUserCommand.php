...
class mmmfestCreateUserCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('mmmfest:create:user')
        ...
        if (!$input->getArgument('orgaId')) {
            ...
            $question->setValidator(
                function ($orgaId) {
                    ...
                    $organizationRepository = $em->getRepository('mmmfestBundle:Organisation');
                    if (empty($orgaId)) {
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $encryption = $this->getContainer()->get('mmmfestBundle.encryption');
        $user         = new User();
        ...
        /** @var \mmmfestBundle\Entity\Organisation $organization */
        $organization = $em->getRepository('mmmfestBundle:Organisation')->find($orgaId);
