...
use coreBundle\Form\AdminSettings;
use coreBundle\Services\ContextManager;
use coreBundle\Services\InviteManager;
...
class AdministrationController extends Controller
{
    ...
    public function registerAction(Request $request,$token)
    {
        ...
        // Fill form
        return $this->render(
            'coreBundle:Admin:register.html.twig',
            array(
    ...
    public function settingsAction(Request $request)
    {
        ...
        return $this->render(
            'coreBundle:Admin:settings.html.twig',
            array(
                'form' => $form->createView(),
                'user' => $user,
            )
    ...
    public function inviteAction(Request $request){
        ...
        return $this->render(
            'coreBundle:Admin:invite.html.twig',
            array(
                'form' => $form->createView(),
            )
        );
