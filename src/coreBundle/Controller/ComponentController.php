...
use coreBundle\Form\ImportType;
...
//                        dump($dataToSave);exit;
        ...
        if($this->container->get('twig.loader')->exists('coreBundle:'.ucfirst($componentName).':'.$componentName.'Form.html.twig')){
            $templateTwig = 'coreBundle:'.ucfirst($componentName).':'.$componentName.'Form.html.twig';
        }else{

            $templateTwig = 'coreBundle:Component:componentForm.html.twig';
        }
        // Fill form
        return $this->render(
            $templateTwig,
